...
object Week21 extends Championship with SI3 with DiSLand {

  override val seed = Islands.seed19
  override val outputDir =  "./output/week21"
  ...
  val theIsland: IslandMap = Islands.week21
  theIsland -> (s"$outputDir/map-week21" as pdf)
  theIsland -> (s"$outputDir/map-week21" as obj)
  theIsland -> (s"$outputDir/map-week21" as json)
